...
# Plot 2
voltage <- as.numeric (electric2$Voltage)
...
# Plot 4
reactivepower <- as.numeric (electric2$Global_reactive_power)
plot (datetime, reactivepower, type = "l", xlab = "datetime", ylab = "Global_reactive_power (kilowatts)")
